...
// sequelize.sync()
	.then(async (result) => {
		...
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29324, 'Zholdybai', 'Sultanbi', 'Zholdybaiuly', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29271, 'Shakuali', 'Zhansaya', 'Dauletkyzy', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29282, 'Shakuali', 'Aizere', 'Dauletkyzy', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29325, 'Zholdybai', 'Sultanbi', 'Zholdybaiuly', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29213, 'Shakuali', 'Zhansaya', 'Dauletkyzy', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29272, 'Shakuali', 'Aizere', 'Dauletkyzy', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29346, 'Zholdybai', 'Sultanbi', 'Zholdybaiuly', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29273, 'Shakuali', 'Zhansaya', 'Dauletkyzy', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29252, 'Shakuali', 'Aizere', 'Dauletkyzy', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29327, 'Zholdybai', 'Sultanbi', 'Zholdybaiuly', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29248, 'Shakuali', 'Zhansaya', 'Dauletkyzy', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29272, 'Shakuali', 'Aizere', 'Dauletkyzy', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29319, 'Zholdybai', 'Sultanbi', 'Zholdybaiuly', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29273, 'Shakuali', 'Zhansaya', 'Dauletkyzy', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29220, 'Shakuali', 'Aizere', 'Dauletkyzy', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29323, 'Zholdybai', 'Sultanbi', 'Zholdybaiuly', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29293, 'Shakuali', 'Zhansaya', 'Dauletkyzy', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
		insert into users ("id", "lastName", "firstName", "patronymic", "password", "createdAt", "updatedAt") values (29202, 'Shakuali', 'Aizere', 'Dauletkyzy', '${hashedPassword}', pg_catalog.now(), pg_catalog.now()) ON CONFLICT DO NOTHING;
